      ...
      <header className="border-b border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center justify-between gap-4 px-6 py-4">
          ...
          <button
            ...
            className="hidden shrink-0 rounded-md border border-zinc-300 px-3 py-1.5 text-sm font-medium hover:bg-zinc-100 lg:inline-flex dark:border-zinc-700 dark:hover:bg-zinc-900"
          >
            Log out
          </button>
          ...
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-zinc-300 lg:hidden dark:border-zinc-700"
          >
            {mobileOpen ? (
